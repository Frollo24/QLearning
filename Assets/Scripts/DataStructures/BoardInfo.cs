...
namespace Assets.Scripts.DataStructures
{
    ...
    {
        public BoardInfo(int columns, int rows, int seed, BoardManager manager)
        {
        ...
        private void LayoutGoalAtRandom(bool forPlanner)
        {
            ...
            while(!goalCell.Walkable)
                goalCell = emptyCells[Random.Range(0, emptyCells.Count)];
        ...
        public object Clone()
        {
            var info = new BoardInfo(this.NumColumns, this.NumRows, this.seed, this.manager) { CellInfos = (CellInfo[,])this.CellInfos.Clone() };
